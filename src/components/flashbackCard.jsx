...
export function FlashbackCard({ title, teamMembers }) {
    const images = [
    ...
    return (
        <div className="py-40  flex items-center justify-center">
            <Modal>
                ...
                <ModalBody>
                    <ModalContent>
                        <h4 className="text-lg md:text-2xl text-neutral-600 dark:text-neutral-100 font-bold text-center mb-8 w-[80%]">
