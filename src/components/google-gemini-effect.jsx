...
export const GoogleGeminiEffect = ({ pathLengths, className }) => {
    return (
        <div className="relative w-screen top-80">
            ...
            <div className="w-full h-[890px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute ">
                ...
                <div className="mt-6 flex justify-center items-center">
                    <div className="w-full h-screen flex items-center justify-center  inset-0">
                        <p className="text-3xl font-bold font-sans z-50">
                            WELCOME
                        </p>
                    </div>
                </div>
